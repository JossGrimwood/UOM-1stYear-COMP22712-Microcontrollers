...
PrintString ; write string indexed by r0
    ...
    NEXT_CHAR                       ; Loop through char array
        ...
        BNE Char                    ; Jump to write char
        BL NewLine                  ; Write new line
        B NEXT_CHAR                 ; Loop for nxt char
    Char
        BL PrintChar                ; Print loaded char 
        B NEXT_CHAR                 ; Loop for next char
    EOS
        
        POP {PC, R0-R1}             ; Pop registers back and update pc

PrintChar   ; write single Char from r0
